...
#define hmac_sha512_nb_round 2048 // 1 // 2048

#define KEY66_HIGH_BYTE 0x2 // 0x3 // 0x2 // 32 BTC Puzzle
//
...
private:
  ...
  void getKeysFromRandomSeed(int pow2L, int pow2U, bool master, int nbThread, Int *keys);// new seed
  //void ChildKeyDerivation_CKD_Private(Int Kpar, Int Cpar, Int KeyR);// CKD Priv
  //void ChildKeyDerivation_CKD_Public(Int Kpar, Int Cpar, Int KeyR);// CKD Pub
