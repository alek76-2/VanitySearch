...
void printUsage() {
  ...
  printf(" -bip39 number: Enable Generate Seed of BIP-39 word list use PRNG, default: disable\n");
  printf(" -brainwallet number: Enable Brainwallet algoritm. Set number 1-16, default 12 words\n");
...
int main(int argc, char* argv[]) {
  ...
  string seed = "";
  string start_key = "";
  int rand_bit = (int)TARGET_KEY_BITS;// Random Bit 66 Puzzle 32 BTC
  ...
  printf("[===========================================================]\n");
  printf("[    Options added argv [-bip39] [-brainwallet]             ]\n");
  ...
  VanitySearch *v = new VanitySearch(secp, prefix, seed, start_key, rand_bit, FuncLevel, searchMode, gpuEnable, stop, bip39, brainwallet, nb_word, outputFile, sse,
