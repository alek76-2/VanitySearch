...
// The modification by Alek76 date 10.01.2024
...
// ROUND 1
#define SHA256_RND_0 {\
S2Round(a, b, c, d, e, f, g, h, 0x428A2F98ul, w[0]);\
S2Round(h, a, b, c, d, e, f, g, 0x71374491ul, w[1]);\
S2Round(g, h, a, b, c, d, e, f, 0xB5C0FBCFul, w[2]);\
S2Round(f, g, h, a, b, c, d, e, 0xE9B5DBA5ul, w[3]);\
S2Round(e, f, g, h, a, b, c, d, 0x3956C25Bul, w[4]);\
S2Round(d, e, f, g, h, a, b, c, 0x59F111F1ul, w[5]);\
S2Round(c, d, e, f, g, h, a, b, 0x923F82A4ul, w[6]);\
S2Round(b, c, d, e, f, g, h, a, 0xAB1C5ED5ul, w[7]);\
S2Round(a, b, c, d, e, f, g, h, 0xD807AA98ul, w[8]);\
S2Round(h, a, b, c, d, e, f, g, 0x12835B01ul, w[9]);\
S2Round(g, h, a, b, c, d, e, f, 0x243185BEul, w[10]);\
S2Round(f, g, h, a, b, c, d, e, 0x550C7DC3ul, w[11]);\
S2Round(e, f, g, h, a, b, c, d, 0x72BE5D74ul, w[12]);\
S2Round(d, e, f, g, h, a, b, c, 0x80DEB1FEul, w[13]);\
S2Round(c, d, e, f, g, h, a, b, 0x9BDC06A7ul, w[14]);\
S2Round(b, c, d, e, f, g, h, a, 0xC19BF174ul, w[15]);\
}

// ROUND 2
#define SHA256_RND_16 {\
S2Round(a, b, c, d, e, f, g, h, 0xE49B69C1ul, w[0]);\
S2Round(h, a, b, c, d, e, f, g, 0xEFBE4786ul, w[1]);\
S2Round(g, h, a, b, c, d, e, f, 0x0FC19DC6ul, w[2]);\
S2Round(f, g, h, a, b, c, d, e, 0x240CA1CCul, w[3]);\
S2Round(e, f, g, h, a, b, c, d, 0x2DE92C6Ful, w[4]);\
S2Round(d, e, f, g, h, a, b, c, 0x4A7484AAul, w[5]);\
S2Round(c, d, e, f, g, h, a, b, 0x5CB0A9DCul, w[6]);\
S2Round(b, c, d, e, f, g, h, a, 0x76F988DAul, w[7]);\
S2Round(a, b, c, d, e, f, g, h, 0x983E5152ul, w[8]);\
S2Round(h, a, b, c, d, e, f, g, 0xA831C66Dul, w[9]);\
S2Round(g, h, a, b, c, d, e, f, 0xB00327C8ul, w[10]);\
S2Round(f, g, h, a, b, c, d, e, 0xBF597FC7ul, w[11]);\
S2Round(e, f, g, h, a, b, c, d, 0xC6E00BF3ul, w[12]);\
S2Round(d, e, f, g, h, a, b, c, 0xD5A79147ul, w[13]);\
S2Round(c, d, e, f, g, h, a, b, 0x06CA6351ul, w[14]);\
S2Round(b, c, d, e, f, g, h, a, 0x14292967ul, w[15]);\
}

// ROUND 3
#define SHA256_RND_32 {\
S2Round(a, b, c, d, e, f, g, h, 0x27B70A85ul, w[0]);\
S2Round(h, a, b, c, d, e, f, g, 0x2E1B2138ul, w[1]);\
S2Round(g, h, a, b, c, d, e, f, 0x4D2C6DFCul, w[2]);\
S2Round(f, g, h, a, b, c, d, e, 0x53380D13ul, w[3]);\
S2Round(e, f, g, h, a, b, c, d, 0x650A7354ul, w[4]);\
S2Round(d, e, f, g, h, a, b, c, 0x766A0ABBul, w[5]);\
S2Round(c, d, e, f, g, h, a, b, 0x81C2C92Eul, w[6]);\
S2Round(b, c, d, e, f, g, h, a, 0x92722C85ul, w[7]);\
S2Round(a, b, c, d, e, f, g, h, 0xA2BFE8A1ul, w[8]);\
S2Round(h, a, b, c, d, e, f, g, 0xA81A664Bul, w[9]);\
S2Round(g, h, a, b, c, d, e, f, 0xC24B8B70ul, w[10]);\
S2Round(f, g, h, a, b, c, d, e, 0xC76C51A3ul, w[11]);\
S2Round(e, f, g, h, a, b, c, d, 0xD192E819ul, w[12]);\
S2Round(d, e, f, g, h, a, b, c, 0xD6990624ul, w[13]);\
S2Round(c, d, e, f, g, h, a, b, 0xF40E3585ul, w[14]);\
S2Round(b, c, d, e, f, g, h, a, 0x106AA070ul, w[15]);\
}

// ROUND 4
#define SHA256_RND_48 {\
S2Round(a, b, c, d, e, f, g, h, 0x19A4C116ul, w[0]);\
S2Round(h, a, b, c, d, e, f, g, 0x1E376C08ul, w[1]);\
S2Round(g, h, a, b, c, d, e, f, 0x2748774Cul, w[2]);\
S2Round(f, g, h, a, b, c, d, e, 0x34B0BCB5ul, w[3]);\
S2Round(e, f, g, h, a, b, c, d, 0x391C0CB3ul, w[4]);\
S2Round(d, e, f, g, h, a, b, c, 0x4ED8AA4Aul, w[5]);\
S2Round(c, d, e, f, g, h, a, b, 0x5B9CCA4Ful, w[6]);\
S2Round(b, c, d, e, f, g, h, a, 0x682E6FF3ul, w[7]);\
S2Round(a, b, c, d, e, f, g, h, 0x748F82EEul, w[8]);\
S2Round(h, a, b, c, d, e, f, g, 0x78A5636Ful, w[9]);\
S2Round(g, h, a, b, c, d, e, f, 0x84C87814ul, w[10]);\
S2Round(f, g, h, a, b, c, d, e, 0x8CC70208ul, w[11]);\
S2Round(e, f, g, h, a, b, c, d, 0x90BEFFFAul, w[12]);\
S2Round(d, e, f, g, h, a, b, c, 0xA4506CEBul, w[13]);\
S2Round(c, d, e, f, g, h, a, b, 0xBEF9A3F7ul, w[14]);\
S2Round(b, c, d, e, f, g, h, a, 0xC67178F2ul, w[15]);\
}
...
__device__ void SHA256Transform(uint32_t s[8],uint32_t* w) {
  ...
  SHA256_RND_0;//SHA256_RND(0);
  WMIX();
  SHA256_RND_16;//SHA256_RND(16);
  WMIX();
  SHA256_RND_32;//SHA256_RND(32);
  WMIX();
  SHA256_RND_48;//SHA256_RND(48);
...
#define ripemd160_sizedesc_32 0x100ULL
